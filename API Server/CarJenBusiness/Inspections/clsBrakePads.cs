...
{
    public class clsBrakePads : clsBaseInspection, IPrimaryInspectionData
    {
        public clsBrakePads()
        {
            base.Name = "BrakePads";
        ...
        private clsBrakePads(short? condition, string recommendation)
        {
            Condition = condition;
        ...
        public IPrimaryInspectionData Find(int inspectionID)
        {
            ...
            if (CarInspectionRepository.GetSingleInspectionResultByID("SP_GetBrakePadsByID", inspectionID, ref condition, ref recommendation))
                return new clsBrakePads(condition, recommendation);
            return null;
        }
