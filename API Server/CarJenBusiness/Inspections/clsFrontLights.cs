...
{
    public class clsFrontLights : clsBaseInspection, IPrimaryInspectionData
    {
        public clsFrontLights()
        {
            base.Name = "FrontLights";
            base.Condition = null;
            base.Recommendation = null;
        }
        private clsFrontLights(short? condition, string recommendation)
        {
            Condition = condition;
        ...
        public IPrimaryInspectionData Find(int inspectionID)
        {
            ...
            if (CarInspectionRepository.GetSingleInspectionResultByID("SP_GetFrontLightsByID", inspectionID, ref condition, ref recommendation))
                return new clsFrontLights(condition, recommendation);
            return null;
        }
